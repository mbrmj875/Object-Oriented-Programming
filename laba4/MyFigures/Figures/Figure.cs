...
namespace MyFigures
{
    abstract public class Figure
    {
        ...
        public void DrawText(string type, int x, int y, int width, int height)
        {
            Graphics g = Graphics.FromImage(bitmap);
            g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.AntiAlias;
            StringFormat sf = new StringFormat
            ...
            g.DrawString($"{type}", new Font("Times New Roman", 10), Brushes.Gray, new RectangleF(x, y, width, height), sf);
        }
